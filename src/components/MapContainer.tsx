...
export default function MapContainer({
  ...
  return (
    <div className="relative flex h-screen w-screen overflow-hidden">
      ...
      <Transition
        show={!!selectedTrack}
        enter="transform transition duration-400 ease-in-out"
      ...
      >
        <div className="hidden md:block absolute left-0 top-0 h-full w-90 bg-white z-50 drop-shadow-xl drop-shadow-black/40">
          <div
      ...
      >
        <div className="block md:hidden absolute bottom-0 left-0 z-50 px-4 py-6 bg-white w-full drop-shadow-t-xl rounded-t-2xl h-[90vh] drop-shadow-xl drop-shadow-black">
          <div
      ...
      {/* Map */}
      <div
        className="flex-1 flex justify-center items-center overflow-hidden z-40 transition-transform duration-400 ease-in-out"
        style={{
          transform:
            selectedTrack && window.innerWidth >= 768
              ? "translateX(18vw)"
              : "translateX(0)",
        }}
      >
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className="absolute top-0 left-0 w-screen h-screen opacity-90 z-0 pointer-events-none">
          <img
